...
const _metal = _interopRequireDefault(require('./metal'));
...
describe('Metal mine informations should be correctly return when', () => {
  it('Level 10 is given and universe speed is 5', () => {
    const mine = _buildings.default[1].base;
    const metalMine = (0, _metal.default)(mine, 10, 5);
  ...
  it('Level 36 is given and universe speed is 5', () => {
    const mine = _buildings.default[1].base;
    const metalMine = (0, _metal.default)(mine, 36, 5);
    expect(metalMine).toEqual({
      production: 166928,
      energy: 11128,
      metal: 87366576,
